...
This report analyzes event characteristics across the RLadies+ network to identify successful patterns and guide organizers in planning effective events.
...
events_analyzed <- events |>
  ...
  mutate(
    ...
    event_hour = hour(as.Date(datetime)),
...
- **Annual celebrations**: Large events for milestones (IWD, RLadies+ Day)  
