...
This report analyzes event titles and descriptions to identify popular topics, emerging trends, and content patterns across the RLadies+ network.
...
#| fig-cap: "Technical topics most frequently mentioned in RLadies+ events. Categories are determined by word-boundary keyword matching."
...
# Five distinguishable RLadies+ purples. unname() is essential:
...
RLadies+ events often connect R skills to specific fields or industries.
