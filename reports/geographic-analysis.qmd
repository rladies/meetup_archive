...
regions_served <- sum(
  regional_events$n[regional_events$region != "Virtual (Global)"] > 0
)
...
- Support 50+ new chapter launches  
- Host 1,000+ events globally  
- Expand presence in underrepresented regions  
- Develop comprehensive organizer training program  
