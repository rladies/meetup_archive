...
- `raw_data/`: Contains raw data files in json format, minimally processed.
- `inactive_chapters`: organised by folder, containing information from Meetup prior to chapter inactivation.
